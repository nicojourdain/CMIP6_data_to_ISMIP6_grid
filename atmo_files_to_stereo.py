...
# PROTECT RCM grid :
f1='/data/njourdain/TMPT2m/RCM_ice_regrid_04000m.nc'
...
#model_list = ['MPI-ESM1-2-HR','UKESM1-0-LL','IPSL-CM6A-LR','CESM2','CNRM-CM6-1','NorESM2-MM','CESM2-WACCM','MRI-ESM2-0','ACCESS-CM2','CanESM5']
model_list = ['CESM2']
#scenar_list = ['historical','ssp126','ssp245','ssp585','piControl']
scenar_list = ['historical','ssp126','ssp245','ssp585']
#var_list=['thetao','so']
var_list=['tas']
