...
#         axs[kisf].plot(s5_years,TF_sp585.values,color=colors[kmod],linewidth=1.5,label='ssp585')
      ...
      if kisf==0:
         axs[kisf].plot([1875,1900],[2.2-kmod*0.2,2.2-kmod*0.2],color=colors[kmod],linewidth=1.5)
         #axs[kisf].plot([1875,1900],[3.0-kmod*0.3,3.0-kmod*0.3],color=colors[kmod],linewidth=1.5)
         axs[kisf].text(1910,2.2-kmod*0.2,model[kmod],fontsize=16,va='center')
...
figname='TF_timeseries_all_models_ssp126.pdf'
