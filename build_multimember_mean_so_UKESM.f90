...
222 FORMAT('/scratchu/njourdain/MULTI_MEMBER_MEAN/so_Omon_UKESM1-0-LL_historical_r0i1p1f2_gn_',a,'.nc')
...
101 FORMAT('/bdd/CMIP6/CMIP/MOHC/UKESM1-0-LL/historical/r',i1,'i1p1f2/Omon/so/gn/latest/so_Omon_UKESM1-0-LL_historical_r',i1,'i1p1f2_gn_',a,'.nc')
501 FORMAT('/bdd/CMIP6/CMIP/MOHC/UKESM1-0-LL/historical/r',i1,'i1p1f3/Omon/so/gn/latest/so_Omon_UKESM1-0-LL_historical_r',i1,'i1p1f3_gn_',a,'.nc')
102 FORMAT('/bdd/CMIP6/CMIP/MOHC/UKESM1-0-LL/historical/r',i2,'i1p1f2/Omon/so/gn/latest/so_Omon_UKESM1-0-LL_historical_r',i2,'i1p1f2_gn_',a,'.nc')
...
status = NF90_PUT_ATT(fidM,so_mean_ID,"coordinates","latitude longitude"); call erreur(status,.TRUE.,"put_att_so_mean_ID")
...
status = NF90_PUT_ATT(fidM,NF90_GLOBAL,"history","Created using build_multimember_mean_so_UKESM.f90")
